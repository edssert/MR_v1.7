...
// v1.3: LA2Xi 추가로 L-Acoustics 5개(LA1.16i/LA12X/LA4X/LA7.16/LA2Xi) +
// d&b 1개(D90) = 6개.
console.log("Test1 (6 amplifiers loaded):", AMPLIFIERS.length === 6 ? "PASS" : "FAIL", `(${AMPLIFIERS.length})`);
...
console.log("Test10 (ampModalBodyHTML renders + has Configurations toggle):", body.includes('data-section-toggle="amp-configs"') ? "PASS" : "FAIL");
