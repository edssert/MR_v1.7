...
export const DB_AMPLIFIERS = [
  {
    ...
    "model": "D90",
    "views": [
      { "label": "Front", "src": "assets/img/amplifiers/db/amp-db-d90-front.webp" },
      { "label": "Rear", "src": "assets/img/amplifiers/db/amp-db-d90-rear.webp" },
      { "label": "Isometric", "src": "assets/img/amplifiers/db/amp-db-d90-isometric.webp" }
    ],
    "channels": 4,
    "powerClass": "Class D",
    "connectivity": [
