...
export const LA_ACCESSORIES = [
  ...
  { "id": "acc-la-k2-rakmount", "mfr": "la", "name": "K2-RAKMOUNT", "type": "Rigging", "price": null, "weight": null, "material": null, "compatibleWith": null, "notes": "4 mounting cradle for LA-RAK (incl. rack stabilizer)", "img": null },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-pow2.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-doe.webp",
    "lengths": [
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-dom-cross.webp",
    "lengths": [
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-domp-2.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-domf.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-domm.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-sp.webp",
  ...
  },
  {
    ...
    "views": [
      { "label": "Front", "src": "assets/img/accessories/la/acc-la-sp-y1.webp" },
      { "label": "Signal Flow", "src": "assets/img/accessories/la/acc-la-sp-y1-signal-flow.webp", "whitebg": true, "whitebg2": true }
    ],
  ...
  },
  {
    ...
    "views": [
      { "label": "Front", "src": "assets/img/accessories/la/acc-la-do-full.webp" },
      { "label": "Connector", "src": "assets/img/accessories/la/acc-la-do.webp" }
    ],
  ...
  },
  {
    ...
    "views": [
      { "label": "Front", "src": "assets/img/accessories/la/acc-la-dofill-la8.webp" },
      { "label": "Spec", "src": "assets/img/accessories/la/acc-la-dofill-la8-spec.webp" }
    ],
  ...
  },
  {
    ...
    "views": [
      { "label": "Front", "src": "assets/img/accessories/la/acc-la-do3wfill.webp" },
      { "label": "Signal Flow", "src": "assets/img/accessories/la/acc-la-do3wfill-signal-flow.webp", "whitebg": true }
    ],
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-dosub-la8.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-sc32.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-sc32-4do.webp",
  ...
  },
  {
    ...
    "img": "assets/img/accessories/la/acc-la-bob32-front.webp",
    // [사용자 제공 사진] 01 = Front(CA-COM/NL4 출력쪽), 02 = Rear(SC32 입력쪽).
    // 원본: raw-data/raw-images/la/accessories/cables/BOB32_CA-COM_01.png,
    // BOB32_SC32_02.png.
    "views": [
      { "label": "Front", "src": "assets/img/accessories/la/acc-la-bob32-front.webp" },
      { "label": "Rear", "src": "assets/img/accessories/la/acc-la-bob32-rear.webp" }
    ],
  ...
  { "id": "acc-la-k1-bump", "mfr": "la", "name": "K1-BUMP", "type": "Rigging", "price": null, "weight": null, "material": null, "compatibleWith": "K1, K1-SB", "notes": "Structure for flying & stacking K1 and K1-SB arrays", "img": "assets/img/speakers/la/k-series/spk-la-k1-array2.webp", "views": [
    { "label": "With K1 (8x K1 + K1-BUMP)", "src": "assets/img/speakers/la/k-series/spk-la-k1-array2.webp" },
    { "label": "With K1-SB (8x K1-SB + K1-BUMP)", "src": "assets/img/speakers/la/k-series/spk-la-k1-sb-array2.webp" }
  ...
  { "id": "acc-la-k1-chariot2", "mfr": "la", "name": "K1-CHARIOT2", "type": "Protections & Transportations", "price": null, "weight": null, "material": null, "compatibleWith": "4 x K1 or 4 x K1-SB", "notes": "Chariot for 4 K1 or 4 K1-SB", "img": "assets/img/accessories/la/acc-la-k1-chariot2.webp", "relatedAccessoryIds": ["acc-la-k1-chariotcov"] },
