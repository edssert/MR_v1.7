...
export const LA_X_SERIES = [
  ...
  },
  {
    ...
    "img": "assets/img/speakers/la/x-series/spk-la-x8i.webp",
    "views": [
      {
        "label": "Front (Black)",
        "src": "assets/img/speakers/la/x-series/spk-la-x8i.webp"
      },
      {
        "label": "Rear (White)",
        "src": "assets/img/speakers/la/x-series/spk-la-x8i-white-rear.webp"
      },
      {
        "label": "Front (White)",
        "src": "assets/img/speakers/la/x-series/spk-la-x8i-white-front.webp"
      }
    ],
    "relations": {
      "ampIds": []
  ...
  },
  {
    ...
    "views": [
      {
        "label": "Front (Black)",
        "src": "assets/img/speakers/la/x-series/spk-la-x6i.webp"
      },
      {
        "label": "Rear (White)",
        "src": "assets/img/speakers/la/x-series/spk-la-x6i-white-rear.webp"
      },
      {
        "label": "Front (White)",
        "src": "assets/img/speakers/la/x-series/spk-la-x6i-white-front.webp"
      }
    ],
    "relations": {
      "ampIds": []
  ...
  },
  {
    ...
    "views": [
      {
        "label": "Front (Black)",
        "src": "assets/img/speakers/la/x-series/spk-la-x4i.webp"
      },
      {
        "label": "Front (White)",
        "src": "assets/img/speakers/la/x-series/spk-la-x4i-white-front.webp"
      },
      {
        "label": "Install (In-Situ)",
        "src": "assets/img/speakers/la/x-series/spk-la-x4i-insitu.webp"
      }
    ],
    "relations": {
      "ampIds": []
  ...
  },
  {
    ...
    "views": [
      {
        "label": "Front",
        "src": "assets/img/speakers/la/x-series/spk-la-x4r.webp"
      },
      {
        "label": "Install (In-Tile)",
        "src": "assets/img/speakers/la/x-series/spk-la-x4r-intile.webp"
      },
      {
        "label": "Install (In-Wall)",
        "src": "assets/img/speakers/la/x-series/spk-la-x4r-inwall.webp"
      }
    ],
    "relations": {
      "ampIds": []
