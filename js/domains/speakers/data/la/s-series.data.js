...
export const LA_S_SERIES = [
  {
    ...
    "views": [
      {
        "label": "Front (Black)",
        "src": "assets/img/speakers/la/s-series/spk-la-soka.webp"
      },
      {
        "label": "Front (White)",
        "src": "assets/img/speakers/la/s-series/spk-la-soka-white-front.webp"
      }
    ],
    "relations": {
      "ampIds": []
  ...
  },
  {
    ...
    "ampRaw": "LA12X(3/12), LA2Xi(BTL1/2), LA2Xi(SE1/4), LA4X(1/4), LA7.16(1/16)",
    "img": "assets/img/speakers/la/s-series/spk-la-soka-inwall.webp",
    "views": [
      {
        "label": "Install (In-Wall)",
        "src": "assets/img/speakers/la/s-series/spk-la-soka-inwall.webp"
      },
      {
        "label": "Install (In-Situ)",
        "src": "assets/img/speakers/la/s-series/spk-la-soka-inwall-insitu.webp"
      }
    ],
    "notes": "Soka의 벽매립(in-wall) 설치용 버전. 음향 스펙(SPL/대역폭/커버리지/앰프 매칭)은 Soka와 동일하나, 벽매립용 부자재가 추가되어 무게가 다름(9.4kg → 11.7kg). 치수는 엔클로저 기준으로 Soka와 동일(공식 홈페이지 자료 기준, 2026-07-10 확보). 이미지는 사용자가 Upload 폴더에 제공한 신규 사진 2장(2026-07-10)으로 반영 — 기존 Soka 카드에 있던 \"Install (In-Wall)\" 뷰를 이 카드로 이전.",
    "relations": {
      "ampIds": []
    },
    "watt": 133
  },
  {
    ...
    "views": [
      {
        "label": "Front",
        "src": "assets/img/speakers/la/s-series/spk-la-syva.webp"
      },
      {
        "label": "With Syva Low",
        "src": "assets/img/speakers/la/s-series/spk-la-syva-syva-low-combo.webp"
      }
    ],
    "relations": {
      "ampIds": []
  ...
  },
  {
    ...
    "views": [
      {
        "label": "Front",
        "src": "assets/img/speakers/la/s-series/spk-la-syva-low.webp"
      },
      {
        "label": "With Syva",
        "src": "assets/img/speakers/la/s-series/spk-la-syva-syva-low-combo.webp"
